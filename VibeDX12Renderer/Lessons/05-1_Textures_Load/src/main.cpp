...
class TexturesLoadApp : public VibeDX12App {
public:
    TexturesLoadApp(HINSTANCE hInstance) : VibeDX12App(hInstance) {
        m_MainWndCaption = L"Lesson 06: Textures Loaded from File";
    }
...
bool TexturesLoadApp::Initialize() {
...
void TexturesLoadApp::BuildRootSignature() {
...
void TexturesLoadApp::BuildShadersAndInputLayout() {
    UINT compileFlags = 0;
#if defined(_DEBUG)
...
void TexturesLoadApp::BuildGeometry() {
...
void TexturesLoadApp::BuildTexture() {
    ...
    if (!img) {
         // Fallback/Retry logic if running from bin/
    ...
    if (!img) {
        throw std::runtime_error("Failed to load texture from Assets/512x512_Texel_Density_Texture_1.png");
    }
...
void TexturesLoadApp::BuildDescriptorHeaps() {
...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE prevInstance, PSTR cmdLine, int showCmd) {
    try {
        ...
        OutputDebugStringA(("CWD: " + cwd.string() + "\n").c_str());

        TexturesLoadApp app(hInstance);
